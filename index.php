    ...
    <div class="container">
      ...
      if(!empty($query->num_rows)){
        while($row = $query->fetch_assoc()){
          if ($session['auth_key_valid'] && isset($_REQUEST['submit']) && $_REQUEST['submit'] === "Edit" && $_REQUEST['productcode'] == $row['productcode'].$row['pid']) {
            ?>
            ...
            <form action="index.php" method="post" class="img">
              ...
              <div class="desc">
                ...
                echo "<input type=\"hidden\" name=\"productcode\" value=\"".$row['productcode'].$row['pid']"\">";
                if ($session['auth_key_valid']) {
