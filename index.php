...
<html lang="en">
  ...
  <body>
   ...
   <div class="img">
	...
	<p style="float:right"><input type="submit" name="shoes1buy" value="Buy"></p></div>
    </div>
    ...
    <div class="desc">เสื้อนักศึกษาแขนสั้น<br> ผู้หญิง
	<br><p style="float:left">฿250</p>
	<p style="float:right"><input type="submit" name="shirt1buy" value="Buy"></p> </div>
    </div>
    ...
    <div class="desc">กระโปรงทรงเอ <br>ผู้หญิง
	<br><p style="float:left">฿200</p>
	<p style="float:right"><input type="submit" name="sk1buy" value="Buy"></p></div>
	</div>
    ...
    <div class="desc">เสื้อนักศึกษาแขนสั้น<br>ผู้ชาย
	<br><p style="float:left">฿250</p>
	<p style="float:right"><input type="submit" name="shirt2buy" value="Buy"></p>
	</div>
    </div>
   ...
   <div class="img">
    ...
    <div class="desc">เสื้อนักศึกษาแขนยาว<br>ผู้ชาย
	<br><p style="float:left">฿290</p>
	<p style="float:right"><input type="submit" name="shirt3buy" value="Buy"></p></div>
    </div>
    ...
    <div class="desc">กางเกงนักศึกษา<br> ผู้ชาย
	<br><p style="float:left">฿280</p>
	<p style="float:right"><input type="submit" name="sk2buy" value="Buy"></p></div>
    </div>
    ...
    <div class="desc">กระโปรงพลีท<br>ผู้หญิง
	<br><p style="float:left">฿280</p>
	<p style="float:right"><input type="submit" name="sk3buy" value="Buy"></p></div>
    </div>
	...
	<br><p style="float:left">฿290</p>
	<p style="float:right"><input type="submit" name="shoes3buy" value="Buy"></p></div>
    </div>
    ...
    <div class="desc">กระโปรงพิธีการ<br> ผู้หญิง
	<br><p style="float:left">฿300</p>
	<p style="float:right"><input type="submit" name="sk4buy" value="Buy"></p></div>
    </div>
    ...
    <div class="desc">กางเกงพิธีการ<br> ผู้ชาย
	<br><p style="float:left">฿300</p>
	<p style="float:right"><input type="submit" name="sk4buy" value="Buy"></p></div>
    </div>
