    ...
    if ($session['session_valid']) {
      ...
      if (!empty($cart_list->num_rows)) {
        ...
        while ($cart_row = $cart_list->fetch_assoc()) {
          ...
          echo "<span class=\"menu__cart__product__qty\"><input type=\"number\" class=\"menu__cart__product__qty__field\" name=\"".$cart_row['itemcode']."\" value=\"".$cart_row['itemqty']."\" data-ovalue=\"".$cart_row['itemqty']."\" min=\"1\" max=\"".$product_array['productqty'.$product_index]."\"></span><div class=\"menu__cart__product__action\"><div class=\"menu__cart__action\"><button type=\"button\" disabled class=\"button__icon button__green button__cart__upload\" data-valueq=\"".$cart_row['itemcode']."\">";
