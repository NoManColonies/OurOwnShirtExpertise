...
if (!empty($retreive_product_result->num_rows)) {
  ...
  while ($product_row = $retreive_product_result->fetch_assoc()) {
    if ($product_row['productlength'] != "" && $product_row['productlength'] != "u") {
      ?>
      <div class="option">
        <input type="radio" class="radio" name="productbuylength" id="<?php echo $product_row['productlength']; ?>" value="<?php echo $product_row['productlength']; ?>">
      ...
      ?>
      <div class="option">
        <input type="radio" class="radio" name="productbuylength" id="default" value="u">
