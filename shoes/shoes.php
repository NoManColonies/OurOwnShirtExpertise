  ...
  <body>
    <div class="head">
      <ul>
        ...
        <li><a class="active" href="../about/about.php"><i class="fas fa-building"></i>เกี่ยวกับเรา</a></li>
        ...
        <li><a class="active" href="../shoes/shoes.php"><i class="fas fa-shoe-prints"></i>รองเท้านักศึกษา</a></li>
